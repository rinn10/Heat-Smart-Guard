(async function () {
  const form = document.getElementById("flood-risk-form");
  ...
  form.addEventListener("submit", async (event) => {
    ...
    const API_URL = "https://fumist.pythonanywhere.com/calculate_flood_risk";
    ...
    try {
      ...
      window.location.href = "Flood_result.html";
    } catch (err) {
      console.error(err);
